document.addEventListener('DOMContentLoaded', function () {
  ...
  function getErrorMessage(type, name, param) {
    const messages = {
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '74b26db5-99bb-440a-b0c1-63c396e0559b',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '74b26db5-99bb-440a-b0c1-63c396e0559b';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '74b26db5-99bb-440a-b0c1-63c396e0559b';
